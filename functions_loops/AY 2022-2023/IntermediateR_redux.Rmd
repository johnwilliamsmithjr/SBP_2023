...
author: "Data Carpentry contributors & Montana State University R Workshops Team, with edits by JW Smith"
...
different data type (heterogeneity!). Because dataframes have two dimensions (columns and rows), 
...
> ### Challenge 1 (Part 1) ![](images/mild.jpg)
>
>I want to extract the 3rd and 4th columns. What is wrong with 
>my code? 

```{r challenge-2, exercise=TRUE, exercise.lines = 7, exercise.setup="moreExtract-setup", error = TRUE}
...
> ### Challenge 1 (Part 2) ![](images/mild.jpg)
>
...
```{r extractLetters, exercise=TRUE, exercise.setup="challenge-4-setup"}
...
```{r challenge-7, exercise=TRUE, exercise.lines=10, exercise.setup="okCupid-setup"}
...
> ### Challenge 13 ![](images/medium.jpg)
>
...
> ### Challenge 14 ![](images/medium.jpg)
>
...
```{r challenge-18, exercise=TRUE, exercise.lines=7, exercise.setup="challenge-17-setup"}
